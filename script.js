...
window.openModal = function(index) {
    // Берем данные из массива products, который ты прописал в HTML
    ...
    void content.offsetWidth; // Магия для перезапуска анимации
...
function updateCartUI() {
    ...
    // Считаем общую сумму (убираем валюту для счета)
    let total = 0;
    cart.forEach(item => {
